...
def load_library():
    if os.path.exists(data_file):  # Fixed typo: 'exits' -> 'exists'
...
def display_statistics(library):
    ...
    read_books = sum(1 for book in library if book['read'])  # Fixed bug here
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            library = remove_book(library)  # Save updated library
        elif choice == '3':
